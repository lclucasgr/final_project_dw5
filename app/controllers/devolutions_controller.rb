   ...
   def create
     ...
     if @devolution.save
       ...
       ActionCable.server.broadcast "notification",
            message: "#{@devolution.book.loans.first.student.name} emprestou o livro #{@devolution.book.title} dia #{@devolution.book.loans.first.created_at} com data prevista para #{@devolution.book.loans.first.created_at + 7.days} foi devolvido dia #{@devolution.created_at}
            ",
